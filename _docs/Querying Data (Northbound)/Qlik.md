...
<img src="../../assets/img/qlik1.png" height=50% width=50% alt="source options" />
4. We use a standard _REST_
<img src="../../assets/img/qlik2.png" height=50% width=50% alt="source options" />
...
| <img src="../../assets/img/qlik3.png" height=50% width=50% /> | <img src="../../assets/img/qlik4.png" height=50% width=50% /> |
|:-------------------------------------------------:|:-------------------------------------------------:|
...
<img src="../../assets/img/qlik5.png" height=50% width=50% />
...
2. In the headers section add the following params: 
    ...
    * **destination**: `network`
<img src="../../assets/img/qlik6.png" height=50% width=50% />

3. Validate the data and continue 
<img src="../../assets/img/qlik7_increments.png" height=50% width=50% />

4. Create a new Analytics
<img src="../../assets/img/qlik8.png" height=50% width=50% />

5. Create a graph based on the given Dimensions 
<img src="../../assets/img/qlik9_increments.png" height=50% width=50% />
...
3. Validate the data and continue 
<img src="../../assets/img/qlik7_period.png" height=50% width=50% />

4. Create a new Analytics
<img src="../../assets/img/qlik8.png" height=50% width=50% />

5. Create a graph based on the given Dimensions
<img src="../../assets/img/qlik9_period.png" height=50% width=50% />
