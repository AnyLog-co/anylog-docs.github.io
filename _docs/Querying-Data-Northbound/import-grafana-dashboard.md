...
Instructions to create and manage your Grafana instance with AnyLog, can be found in [Using Grafana](using%20grafana/) 


The following document provides 3 sample Grafana dashboards
* [Network Map](grafana.json) - The dashboard consists of a map showing all the nodes 
...
|:-----------------------------------------------:|:---------------------------------------------------------------------------:| :---: | :---:  |
| ![Edit Widget](../../assets/img/grafana_edit_button.png) | ![grafana_update_datasource.png](..%2Fimgs%2Fgrafana_update_datasource.png) | ![grafana_update_table.png](..%2Fimgs%2Fgrafana_update_table.png) | ![grafana_outcome.png](..%2Fimgs%2Fgrafana_outcome.png) |   
